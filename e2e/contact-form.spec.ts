...
test.describe('Contact Form', () => {
  ...
  test('should fill form correctly', async ({ page }) => {
    ...
    await page.locator('textarea[name="message"]').first().fill('This is a test message for the contact form.');
...
test.describe('Contact Form Submission', () => {
  test('should submit form successfully with valid data', async ({ page }) => {
    ...
    await page.locator('input[name="name"]').first().fill('Test User');
    await page.locator('input[name="email"]').first().fill('test@example.com');
    await page.locator('textarea[name="message"]').first().fill('This is a test message for the contact form submission test.');
